...
const AdminPanelLayout = ({children} : Props) => {
    ...
    const{user , error , loading , mutate} = useAuth()
    ...
    if(error){
        ...
        toast.error('دسترسی به این صفحه امکان پذیرر نمی باشد.')
        return <></>
    }


     // function Delete Token Login
     const clearToken = () => {
    ...
    const handlerLogout = async () => {
        try {
            let res = await DeleteToApi({url:'/admin/logout'})
            RemoveToken()
                    ...
                    <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white shadow">
                        ...
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            >
                                ...
                                <Menu.Item>
                                    <button onClick={handlerLogout} className="block px-4 py-2 text-sm text-gray-700 text-right w-full hover:bg-gray-100 transition-all">Log Out</button>
                                </Menu.Item>
                                </Menu.Items>
                            </Transition>
                            </Menu>
