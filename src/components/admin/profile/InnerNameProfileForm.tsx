...
type profileNameFormValues = FormikProps<ProfileNameFormValuesInterface>

const InnerNameProfileForm = (props:profileNameFormValues) => {
...
export default InnerNameProfileForm
